...
namespace vortex{
  ...
  auto convertToMaxPool2DAttr(Builder &builder, RankedTensorType type, const std::vector<float> &values) {
  ...
  void MaxPool2DHandler::handleLayer(Builder& builder, FuncOp& funcOp, json& layer){
